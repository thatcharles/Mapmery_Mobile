    ...
    return (
        <View style={{flexDirection:'row', width: 250, height: 130, borderRadius: 5, backgroundColor: 'white', overflow:'hidden'}}>
            <View style={{flex:1, alignContent: 'center', justifyContent:'center'}}>
                <Avatar.Image size={64} style={{margin: 10, marginTop:15, backgroundColor: 'black'}} source={require('../../assets/avatar.jpg')} />
            </View>
            <View style={{flex:2}}>
                ...
                <Text style={{borderRadius: 5, fontWeight: '700'}}>Afternoon in midtown</Text>
                <ScrollView
